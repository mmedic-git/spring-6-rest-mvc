...
class BeerControllerTest {
    ...
    void testCreateNewBeer() throws Exception {
        ...
        */
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25).getContent().get(1)); //za svaki Beer objekt koji se proslijedi metoda
